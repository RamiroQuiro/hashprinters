...
const buttonVariants = {
  base: "inline-flex items-center cursor-pointer justify-center rounded-md text-sm font-thin transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 w-fit disabled:opacity-50 disabled:cursor-not-allowed duration-200",
  variants: {
    variant: {
      primary:
